...
export default function Setor() {
  ...
  const handleSetorUang = async () => {
    ...
    const newTransaksi: Transaksi = {
      ...
      jenis: "setorUang",
      jumlah,
      keterangan: `Menambahkan uang tersimpan Rp${jumlah.toLocaleString()}`,
    };
  ...
  return (
    <View style={styling.formContainer}>
      <Text style={styling.formTitle}>
        <FontAwesome name="building" size={30} color="#192f6a" /> Catat Uang Tersimpan
      </Text>
      ...
      <TouchableOpacity onPress={handleSetorUang} style={styling.button}>
